...
INCLUDE     := -Isrc/common/ -Isrc/controller -Isrc/model -Isrc/proxy
...
VP_OBJECTS      := $(VP_SRC:%.cpp=$(OBJ_DIR)/%.o)
...
$(SRV_TARGET): $(SRV_OBJECTS) $(CTRL_OBJECTS) $(COMMON_OBJECTS) $(MODEL_OBJECTS) $(VP_OBJECTS)
	@mkdir -p $(@D)
